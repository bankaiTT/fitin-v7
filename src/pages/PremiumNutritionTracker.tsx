...
const PremiumNutritionTracker = () => {
  ...
  // Redirect if not paid plan
  useEffect(() => {
    if (userPlan && !isPaidPlan) navigate('/nutrition-tracker');
  ...
  const selectGoal = (goal: 'maintain' | 'cut' | 'bulk') => {
    ...
    toast.success(
      `${goal.charAt(0).toUpperCase() + goal.slice(1)} plan selected! Target: ${targetCalories} kcal/day`
    );
  };
              ...
              <div className="text-center">
                ...
                <div className="bg-red-500/10 border border-red-500/30 rounded-xl p-4 mb-4">
                  <p className="text-2xl font-bold text-red-400">
                    {Math.round(maintenanceCalories * 0.8)} kcal
                  </p>
              ...
              <div className="text-center">
                ...
                <div className="bg-green-500/10 border border-green-500/30 rounded-xl p-4 mb-4">
                  <p className="text-2xl font-bold text-green-400">
                    {Math.round(maintenanceCalories * 1.15)} kcal
                  </p>
